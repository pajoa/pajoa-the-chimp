    ...
    */
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            icon: "icon fontello",
            iconColumns: "icon-fontello-th-list",
            iconDown: "icon-fontello-chevron-down",
            iconRefresh: "icon-fontello-refresh",
            iconUp: "icon-fontello-chevron-up",
        ...
        templates: {
            ...
            row: "<tr>{{ctx.cells}}</tr>",
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon icon-fontello-search\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
